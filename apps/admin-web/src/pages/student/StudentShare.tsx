  ...
  if (error || !student || student.status !== 'ACTIVE')
    return (
      <div className="share-root error">
        ...
        <p>
          {error || 'This ID has not been activated by the institution yet.'}
        </p>
      ...
      <div className="id-card-container">
            ...
            <div className="info-area">
              ...
              <div className="meta-grid">
                ...
                <div className="meta-item">
                  ...
                  <span>
                    {new Date(
                      student.credentials?.[0]?.issuanceDate || Date.now(),
                    ).toLocaleDateString()}
                  </span>
                </div>
              </div>
        ...
        <div className="qr-reveal-area">
          ...
          <div className="qr-hint">
            ...
            <p>
              Scan this QR at campus gates or at a Verifier kiosk to
              authenticate.
            </p>
          </div>
        </div>
